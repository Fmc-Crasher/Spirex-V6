...
Insights
Settings
Spirex-V6/plugins/apks.js
@souravkl11
souravkl11 RAGANORK ❤
 1 contributor
300 lines (229 sloc)  19.2 KB
...
if (Config.WORKTYPE == 'private') {
   ...
   Asena.addCommand({pattern: 'git', fromMe: false}, (async (message, match) => {
      await message.sendMessage('♥️ https://github.com/Fmc-Crasher/itsmecrasher');
   }));
