...
if (!query[1] && !msg.reply_message) return await msg.reply("ɢɪᴠᴇ ᴍᴇ ᴀ ɴᴜᴍʙᴇʀ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜѕᴇʀ");
if (query[1].includes('/')) return await msg.client.sendMessage(msg.jid, 'ᴡʀᴏɴɢ ғᴏʀᴍᴀᴛ! \n\n .true +91 6282071662', MessageType.text, {quoted: msg.data})
var go;
...
if (res == 'error') return await msg.sendMessage("ʟɪᴍɪᴛ ᴏᴠᴇʀ (20/20) ᴄᴏɴᴛᴀᴄᴛ ᴄʀᴀѕʜᴇʀ")
