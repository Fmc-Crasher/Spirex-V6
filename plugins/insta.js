 ...
 ​if​ ​(​res​ ​===​ ​"false"​)​ ​return​ ​await​ ​msg​.​client​.​sendMessage​(​msg​.​jid​,​ ​fail​,​ ​MessageType​.​text​,​ ​{​quoted​: ​msg​.​data​}​)​; 
 ​var​ ​buffer​ ​=​ ​await​ ​raganork​.​query​.​skbuffer​(​res​.​url​) 
 ​if​ ​(​res​.​url​.​includes​(​'mp4'​)​)​ ​return​ ​await​ ​msg​.​client​.​sendMessage​(​msg​.​jid​,​ ​buffer​,​ ​MessageType​.​video​,​ ​{ mimetype: Mimetype.mp4, caption: 'ᴜѕᴇʀɴᴀᴍᴇ: *' + `${res.username}` + '*\n ɴᴀᴍᴇ: *' + `${res.name}` + '*\n ʟɪᴋᴇs: *' + `${res.likes}` + '*', quoted: msg.data});
 ​if​ ​(​res​.​url​.​includes​(​'jpg'​)​)​ ​return​ ​await​ ​msg​.​client​.​sendMessage​(​msg​.​jid​,​ ​buffer​,​ ​MessageType​.​image​,​ ​{ mimetype: Mimetype.mp4, caption: 'ᴜѕᴇʀɴᴀᴍᴇ: *' + `${res.username}` + '*\n ɴᴀᴍᴇ: *' + `${res.name}` + '*\n ʟɪᴋᴇs: *' + `${res.likes}` + '*', quoted: msg.data});
 ​} 
