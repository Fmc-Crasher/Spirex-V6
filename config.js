...
module.exports = {
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'ᴀͥᴅͭᴀᷤʀѕͫʜͤ' : process.env.OWNER_NAME,
    SONGD: process.env.SONGD === undefined ? 'ᴜᴘʟᴏᴀᴅɪɴɢ  𖤍' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '' : process.env.SONGU,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'ʜᴇʀᴍɪ† 𖤍|ᴄͥʀͭᴀᷤѕʜᷟᴇͤʀ' : process.env.STICKER_DATA,
